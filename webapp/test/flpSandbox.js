		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Etiqueta de Materiais",
									"targetURL": "#EtiquetadeMateriais-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"EtiquetadeMateriais-display": {
								"semanticObject": "EtiquetadeMateriais",
								"action": "display",
								"description": "Impressão de etiqueta de materiais do estoque",
								"title": "Etiqueta de Materiais",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.dohler.zui5etqmaterial.zui5mmetqmaterial",
									"url": sap.ui.require.toUrl("br/com/dohler/zui5etqmaterial/zui5mmetqmaterial")
								}
							}
						}
					}
